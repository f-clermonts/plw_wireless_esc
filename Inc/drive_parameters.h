...
#define PID_TORQUE_KI_DEFAULT               2774
#define PID_TORQUE_KD_DEFAULT               100
#define PID_FLUX_KP_DEFAULT                 2312
#define PID_FLUX_KI_DEFAULT                 2774
...
#define PID_SPEED_KP_DEFAULT                2031/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
#define PID_SPEED_KI_DEFAULT                88/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
